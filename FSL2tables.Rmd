...
df.act = read_csv(file.path("fMRI_data", "grp_use-sorted.csv"), 
  ...
  mutate(
    ...
    `eps_colour-rFG`  = scan(file.path("fMRI_data", "eps_c_C7_meants.txt")),
    `eps_colour-rSTS` = scan(file.path("fMRI_data", "eps_c_C6_meants.txt")),
    `eps_colour-rINS` = scan(file.path("fMRI_data", "eps_c_C5_meants.txt")),
    `eps_colour-rACC` = scan(file.path("fMRI_data", "eps_c_C4_meants.txt")),
    # load zstats for mu-z
    `mu_colour-rINS`  = scan(file.path("fMRI_data", "mu_c_C3_meants.txt")),
    `mu_colour-lINS`  = scan(file.path("fMRI_data", "mu_c_C4_meants.txt")),
    `mu_colour-rACC`  = scan(file.path("fMRI_data", "mu_c_C5_meants.txt")),
    `mu_colour-rSMG`  = scan(file.path("fMRI_data", "mu_c_C6_meants.txt")),
    `mu_colour-PRC`   = scan(file.path("fMRI_data", "mu_c_C7_meants.txt")),
    # load zstats for mu-e
    `mu_emotion-rPRC`  = scan(file.path("fMRI_data", "mu_e_C4_meants.txt")),
    `mu_emotion-rFG`   = scan(file.path("fMRI_data", "mu_e_C3_meants.txt")),
    `mu_emotion-lFG`   = scan(file.path("fMRI_data", "mu_e_C2_meants.txt")),
