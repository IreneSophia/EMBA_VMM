function c = tapas_hgf_binary_k2_0_config_emotion
% This is an adaptation from a TAPAS file to model a two level HGF. The
% adaptation was written by Anna Yurova and consists of setting the
% variance to zero to keep the third parameter fixed. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
